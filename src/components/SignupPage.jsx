...
export default function SignupPage({ onSwitch = () => {}, onSuccess, apiBaseUrl }) {
    ...
    const handleSignup = async (e) => {
        ...
        const API_URL = `${apiBaseUrl}/api/signup`;
        ...
        try {
            ...
            setMessage(
                "❌ Could not connect to the server. Ensure the Node.js server is running and the API Base URL is correct."
            );
        }
        // ----------------------------------------------------------------------
    };
